...
namespace AnchorModeling.Example
{
    class Program
    {
        ...
        static async Task SelectAnchorValues()
        {
            ...
            Console.WriteLine($"History of book1 {nameof(T_Users_Book1_to_Books)}:");
            (await db.T_Users_Book1_to_Books
